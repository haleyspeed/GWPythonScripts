...
def get_data (dir, group):
	...
	surface_area = 0 
	volume = 0
	row = {'mouse_id':[], 'group':[], 'branch_points':[],  'total_spines':[], 'thin':[], 'stubby':[], 'mushroom':[], 'filopodia':[],  '%thin':[], '%stubby':[], '%mushroom':[], '%filopodia':[], 'length':[],'surface_area':[], 'volume':[], 'density_0-99':[], 'density_100-199':[], 'density_200-299':[], 'density_300-399':[],'density_400-499':[], 'density_500+':[], 'length_0-99':[], 'length_100-199':[], 'length_200-299':[], 'length_300-399':[], 'length_400-499':[], 'length_500+':[]}
